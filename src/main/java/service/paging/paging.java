...
public class paging {
	...
	private void makePaging() {
        ...
        if (this.pageSize == 0) this.setPageSize(15); // 기본 값 설정
	...
	public String toString() {
		return "paging [페이지 당 게시글 수=" + pageSize + ", 첫 페이지 번호=" + firstPageNo + ", 앞 페이지 번호=" + prevPageNo
				+ ", 시작페이지 번호=" + startPageNo + ", 현재 페이지 번호=" + pageNo + ", 끝 페이지 번호=" + endPageNo + ", 다음 페이지 번호="
				+ nextPageNo + ", 마지막 페이지 번호=" + finalPageNo + ", 총 게시물 수=" + totalCount + "]";
	}
}
