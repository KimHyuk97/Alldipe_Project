...
/**
 * Servlet implementation class memberListWindowModeController
 */
@WebServlet("/admin/member/memberListWindowMode")
public class memberListWindowModeController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("./memberListWindowMode.jsp");
