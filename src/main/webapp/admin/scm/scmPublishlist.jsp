...
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/css/scm/total_publishlist.css">
        ...
        <div class="search_cont">
            ...
            <div class="sch_ck_cont">
                ...
                <div class="sch_check">
                    ...
                    <label for="ck21"><input type="checkbox" name="ck20" id="ck21">품절</label>
                    <label for="ck22"><input type="checkbox" name="ck20" id="ck22">삭제상품</label>
                    <label for="ck22"><input type="checkbox" name="ck20" id="ck22">정상</label>
                </div>
            </div>     
        </div>
