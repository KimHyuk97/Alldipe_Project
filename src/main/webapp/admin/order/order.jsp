...
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/css/order/total_order.css">
<!--상단-->
<jsp:include page="../adminHeader.jsp" flush="false"/>
  <div class="cont_wrap">
        ...
        <div class="nav">
            <ul>
                <li value="1" onclick="CB()" class="on">전체 주문 리스트</li>
                <li value="2" onclick="CB()">입금대기 리스트</li>
                <li value="3" onclick="CB()">결제완료 리스트</li>
            </ul>
                <button>검색</button>
                <button>초기화</button>
        </div>
