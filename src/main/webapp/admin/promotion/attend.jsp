...
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/css/promotion/total_attend.css">
...
<div class="cont_wrap">
        ...
        <div class="search_cont">
            ...
            <div class="sch_ck_cont">
                ...
                <div class="sch_check">
                    <p>진행상태</p>
                    <label for="ra01" id="la01"><input type="radio" name="use01" id="ra01">전체</label>
                    <label for="ra02" id="la01"><input type="radio" name="use01" id="ra02">진행중</label>
                    <label for="ra03" id="la01"><input type="radio" name="use01" id="ra03">종료</label>
                    <label for="ra04" id="la01"><input type="radio" name="use01" id="ra04">예약</label>
                </div>
                <div class="sch_check">
                    <p>출석체크 유형</p>
                    <label for="ra05" id="la02"><input type="radio" name="use02" id="ra05">전체</label>
                    <label for="ra06" id="la02"><input type="radio" name="use02" id="ra06">누적</label>
                    <label for="ra07" id="la02"><input type="radio" name="use02" id="ra07">연속</label>
                    <label for="ra08" id="la02"><input type="radio" name="use02" id="ra08">출석할 때마다</label>
                </div>
                <div class="sch_check">
                    <p>출석체크 유형</p>
                    <label for="ra09" id="la03"><input type="radio" name="use03" id="ra09">전체</label>
                    <label for="ra10" id="la03"><input type="radio" name="use03" id="ra10">스탬프형</label>
                </div>
            </div>     
        </div>
