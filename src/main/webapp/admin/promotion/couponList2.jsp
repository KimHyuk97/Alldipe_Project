...
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/css/promotion/total_coupon.css">
<!--상단-->
  ...
  <div class="cont_wrap">
        ...
        <div class="search_cont">
            ...
            <div class="sch_ck_cont">
                ...
                <div class="sch_check">
                    <p>사용여부</p>
                    <label for="use01" id="la01"><input type="radio" name="use" id="use01">사용</label>
                    <label for="use02" id="la01"><input type="radio" name="use" id="use02">사용안함</label>
                </div>
