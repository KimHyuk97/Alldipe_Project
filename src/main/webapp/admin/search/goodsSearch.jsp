...
<body>
<div class="cont_wrap windowMode">
        <div class="search_cont">
        <form action="./searchGoodsList" method="post">
            <div class="sch_tit">
              <h2>상품 리스트</h2> 
        ...
        <div class="sch_result">
            ...
            <div class="sch_btn">
            	<div class="btn_left"><button type="button" onclick="sendGoods()">적용</button></div>
                <div class="btn_right">
...
<script src="${pageContext.request.contextPath }/admin/js/search/category.js"></script>
<script src="${pageContext.request.contextPath }/admin/js/search/brand.js"></script>
<script src="${pageContext.request.contextPath }/admin/search/goodsSearch.js"></script>
<script>
<%if(cate1 == null){%>
